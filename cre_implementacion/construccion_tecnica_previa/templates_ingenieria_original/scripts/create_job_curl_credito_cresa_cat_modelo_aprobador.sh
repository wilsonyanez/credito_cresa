#!/usr/bin/env bash
# Script para crear el job ingest_credito_cresa_cat_modelo_aprobador en Databricks
...
JOB_JSON="templates_ingenieria/config/jobs/credito_cresa_cat_modelo_aprobador_job.json"
