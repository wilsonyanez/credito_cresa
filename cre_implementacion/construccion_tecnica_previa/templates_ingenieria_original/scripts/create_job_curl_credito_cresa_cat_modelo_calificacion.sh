#!/usr/bin/env bash
# Script para crear el job ingest_credito_cresa_cat_modelo_calificacion en Databricks
...
JOB_JSON="templates_ingenieria/config/jobs/credito_cresa_cat_modelo_calificacion_job.json"
